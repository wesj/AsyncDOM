 ...
 *   var myPromise = getPromiseResolvedOnTimeoutWithValue(1000, "Value");
...
// reported (possibly redundantly) so as to var programmers fix their code.
...
function TaskImpl(iterator) {
  ...
  new Promise(function (resolve, reject) {
    self.deferred = { resolve: resolve, reject: reject, promise: this };
    self._iterator = iterator;
    self._isStarGenerator = !("send" in iterator);
    self._run(true);
  })
}
